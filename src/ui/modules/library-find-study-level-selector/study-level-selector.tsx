    ...
    <div className={style.study_level_selector}>
      {prek && (
        ...
        <Dropdown title={t('t389')}>         
          <DropdownItem>{/* 모든 단계 */}{t('t389')}</DropdownItem>
          <DropdownItem>{/* 단계 1. 알파벳 학습 */}{t('t839')}</DropdownItem>
          <DropdownItem>{/* 단계 2. 파닉스 학습 */}{t('t840')}</DropdownItem>
          <DropdownItem>{/* 단계 3. 단어 학습 */}{t('t841')}</DropdownItem>
          <DropdownItem>{/* 단계 4. 스토리 읽기 */}{t('t842')}</DropdownItem>
        </Dropdown>
      )}
      {level && (
